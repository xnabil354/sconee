          ...
          <div class="grid grid-cols-2 sm:grid-cols-3">
            <div className=" ">
              ...
              <ul class="text-gray-400 dark:text-gray-400 font-medium">
                <li class="mb-2">
                  <a
                    href="https://www.instagram.com/xzhndvs"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/cctvsconee"
                    class="hover:underline"
                  >
                    Sconee
                  </a>
            ...
            <div className="">
              ...
              <ul class="text-gray-400 dark:text-gray-400 font-medium">
                ...
                <li>
                  <a href="https://sman15jkt.sch.id" class="hover:underline">
                    Official SMAN 15 Jakarta Website
                  </a>
                </li>
              </ul>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <div class="flex mt-4 justify-center sm:mt-0">
            <p className="text-[0.7rem] text-white opacity-70">
              © {new Date().getFullYear()} Class XII MIPA 1 | Development by
              Sconee
            </p>
          </div>
        </div>
